...
public final class EventsUtil {
     ...
     *            The log message
     */
    public static void sendEvent(final Collection<IJNRPEEventListener> listenersList, final Object sender, final LogEvent evt, final String message) {
    ...
    public static void sendEvent(final JNRPEExecutionContext context, final Object sender, final LogEvent evt, final String message) {
     ...
     */
    public static void sendEvent(final Collection<IJNRPEEventListener> listenerList, final Object sender, final LogEvent evt, final String message,
            final Throwable exception) {
        ...
        if (exception != null) {
            sendEvent(listenerList, sender, evt.name(), new EventMessageParam(message), new EventExceptionParam(exception));
        } else {
            sendEvent(listenerList, sender, evt.name(), new EventMessageParam(message));
        }
    }
     ...
     */
    public static void sendEvent(final Collection<IJNRPEEventListener> listenerList, final Object sender, final String customEvtType,
