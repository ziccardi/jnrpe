...
public enum TimeUnit {
     ...
     * 
     * @param qty the quantity of SECONDS, MINUTES, HOURS or DAYS
    ...
    /**
     * Returns the current time in terms of number of TimeUnit since
     * 1st January 1970.
     * @return the current time in terms of number of TimeUnit since
     * 1st January 1970
     */
