...
public class ResultSetMock implements ResultSet {
    ...
    private final List<ResultSetMockRow> m_vResult;

    private Iterator<ResultSetMockRow> m_resultIterator = null;
    private ResultSetMockRow m_curValue = null;

    public ResultSetMock(List<ResultSetMockRow> vResult) {
        m_vResult = vResult;
    ...
    public boolean next() throws SQLException {
        if (m_resultIterator.hasNext()) {
            m_curValue = m_resultIterator.next();
            return true;
        }
    ...
    public int getInt(int columnIndex) throws SQLException {
        return (Integer) m_curValue.getValue(columnIndex);
    }

    public long getLong(int columnIndex) throws SQLException {
        return (Long) m_curValue.getValue(columnIndex);
    }
    ...
    public int getInt(String columnLabel) throws SQLException {
        return (Integer) m_curValue.getValue(columnLabel);
    }
    ...
    public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
        return new BigDecimal(m_curValue.getValue(columnIndex).toString());
    }

    public BigDecimal getBigDecimal(String columnLabel) throws SQLException {
        return new BigDecimal(m_curValue.getValue(columnLabel).toString());
    }
