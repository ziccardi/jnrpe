...
public class HelpCommand extends ConsoleCommand {
	...
	public HelpCommand(ConsoleReader consoleReader, JNRPE jnrpe,
	...
	public boolean execute(String[] args) throws Exception {
		...
		if (args.length != 1) {
			getConsole().println(
					"Only one parameter can be specified for the help command");
			return false;
		}
	...
	public void printHelp() throws IOException {
		...
		getConsole().println(
				"   Without parameters shows the list of available commands");
		getConsole().println(
				"   otherwise prints some help about the specified command");
	}
