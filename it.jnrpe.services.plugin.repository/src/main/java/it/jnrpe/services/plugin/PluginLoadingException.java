...
/**
 * Exception thrown when there's an error loading plugins from ZIP files.
 */
public class PluginLoadingException extends RuntimeException {
    ...
    /**
     * Constructs a new plugin loading exception with the specified detail message.
     *
    ...
    /**
     * Constructs a new plugin loading exception with the specified detail message and cause.
     *
     * @param message the detail message
