...
module it.jnrpe.server {
    opens it.jnrpe.server to it.jnrpe.engine;
    opens it.jnrpe.server.commands to it.jnrpe.engine;
    opens it.jnrpe.server.commands.plugins to it.jnrpe.engine;
    opens it.jnrpe.server.commands.commands to it.jnrpe.engine;

    requires it.jnrpe.engine;

    provides IConfigSource with ConfigSource;
