...
public class CommandDefinitionValidator implements IConfigSectionValidator {

  private static class CommandConfigValidator extends AbstractSectionValidator {
    protected CommandConfigValidator() {
      super(new String[] {"name", "plugin", "args"}, new String[] {"name", "plugin"});
    }
  }
  ...
  public void validate(Object section) throws InvalidConfigurationException {
    ...
    CommandConfigValidator bcv = new CommandConfigValidator();

    var data = (List<Map<String, Object>>) section;
    for (var binding : data) {
      bcv.validate(binding);
    }
  }
}
