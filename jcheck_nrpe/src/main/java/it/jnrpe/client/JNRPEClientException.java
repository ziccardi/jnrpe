...
public class JNRPEClientException extends Exception {
     ...
     *         unknown.)
     */
    public JNRPEClientException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public JNRPEClientException(final String message) {
        super(message);
    }
     ...
     *         unknown.)
     */
    public JNRPEClientException(final Throwable cause) {
        super(cause);
    }
